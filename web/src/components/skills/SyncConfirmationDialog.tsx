      ...
      >
        ...
        <div className="p-4 pb-2">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-md bg-warning-muted border border-warning/20 flex items-center justify-center shrink-0">
        ...
        <div className="flex items-center justify-end gap-2 p-4 pt-2 border-t border-default bg-input">
          ...
          {pendingSyncCount > 0 && (
            <button
              onClick={onPushFirst}
              className="h-7 px-3 bg-highlight-muted hover:bg-highlight/20 border border-highlight/30 text-highlight text-sm font-medium rounded transition-colors duration-150"
            >
              Push Changes First
            </button>
          )}
